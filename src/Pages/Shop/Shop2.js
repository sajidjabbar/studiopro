						...
						<div className="col-lg-6">
							...
							<div className="btn-wrapper1">
								<a
									...
									className={statetab === 0 ? "btn2" : "btn3"}
								>
								...
								<a
									...
									className={statetab === 1 ? "btn2" : "btn3"}
								>
									Reviews
								</a>
							</div>
								...
								<div className="col-lg-12">
									<div className="content-wrapper">
										...
										<p>
											...
											vestibulum morbi blandit cursus risus at. Eget nunc
											lobortis mattis aliquam. Semper auctor neque vitae tempus
											quam. Tempor id eu nisl nunc mi ipsum faucibus. Diam quis
											enim lobortis scelerisque fermentum dui faucibus. Nisi est
											sit amet facilisis magna. Elementum pulvinar etiam non
											quam lacus suspendisse faucibus interdum posuere. Sit amet
											purus gravida quis blandit turpis cursus. Non curabitur
											gravida arcu ac tortor dignissim convallis aenean.
											Scelerisque in dictum non consectetur a erat nam at. Elit
